...
| | 뜻 |
| --- | --- |
| **하루 사용 가능한 금액** | 이 페이스로 쓰면 기간을 딱 맞춘다 |
| **오늘 쓸 수 있는 돈** | 오늘 아직 이만큼 남았다 |
| **오늘 쓴 돈** | 오늘 실제로 나간 돈 |

- **쓴 만큼 정확히 줄어듭니다.** 35,000원을 쓰면 오늘 쓸 수 있는 돈이 35,000원 줄어듭니다.
  하루치 안에서 쓰는 동안은 하루치가 흔들리지 않습니다.
- **넘기면 음수로 알려줍니다.** 하루치 120,000원인데 200,000원을 썼다면 `-80,000원`,
  게이지에는 빗금이 칩니다.
- **넘긴 순간 평균도 같이 내려갑니다.** 위처럼 넘겨 쓰면 하루 사용 가능한 금액이
  그 자리에서 93,300원으로 떨어집니다. 남은 돈을 남은 날로 다시 나눈 값이고,
  내일이 되면 그 숫자가 그대로 이어집니다.
- **아껴 쓰면 반대로 올라갑니다.** 오늘 덜 쓴 만큼 남은 날의 하루치가 늘어납니다.
