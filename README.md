...
- **하루치는 남은 돈을 남은 날로 나눈 값입니다.** 지금까지의 기록이 전부 들어가 있어서,
  지출을 하나 넣는 순간 바로 따라 움직입니다. 지난 날 아껴 쓴 만큼 올라가고,
  넘겨 쓴 만큼 내려갑니다. 아침에 120,000원이던 하루치는 35,000원을 쓰면 111,200원이 됩니다.
- **오늘 쓸 수 있는 돈은 쓴 만큼 정확히 줄어듭니다.** 35,000원을 쓰면 35,000원 줄어듭니다.
  그날 아침 하루치를 기준으로 삼기 때문에 하루 안에서는 기준이 흔들리지 않습니다.
- **넘기면 음수로 알려줍니다.** 아침 하루치 120,000원인데 200,000원을 썼다면 `-80,000원`,
  게이지에는 빗금이 칩니다. 이때 하루 사용 가능한 금액은 70,000원까지 떨어집니다.
- **하루가 지나면 조금 회복됩니다.** 위 상태로 하루가 지나면 같은 남은 돈을
  하루 줄어든 날수로 나누므로 93,300원이 됩니다.
...
무료 한도 안에서만 동작하는 구성이라, 모르는 사이에 요금이 나가는 일이 구조적으로 생기지 않습니다.
